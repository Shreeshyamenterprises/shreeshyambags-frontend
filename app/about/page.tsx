        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-base leading-7 text-zinc-600">
              Shree Shyam Enterprises started with a single belief — that packaging should do two things at once:
              carry the product and carry the brand. Over the years we have grown into a full-scale non-woven
